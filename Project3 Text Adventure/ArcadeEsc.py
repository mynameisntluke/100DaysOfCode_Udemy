...
input("'Freedom is yours if you gather twenty tickets before the witching hour of 3, "
      "damnation is yours for anything less'")

time += 1

input("This all seems insane to you but without any better plan you decide to follow the instructions. "
      "The minute hands screeches again: ")